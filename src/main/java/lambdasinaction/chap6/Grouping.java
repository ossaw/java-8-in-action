...
public class Grouping {
    ...
    private static Map<Dish.Type, Set<String>> groupDishTagsByType() {
        ...
        return null;
        /*
         * return menu.stream().collect(groupingBy(Dish::getType, flatMapping(
         * dish -> dishTags.get(dish.getName()).stream(), toSet())));
         */
    }
    ...
    private static Map<Dish.Type, List<Dish>> groupCaloricDishesByType() {
        ...
        return null;
        /*
         * return menu.stream().collect(groupingBy(Dish::getType, filtering(
